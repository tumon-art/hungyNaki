...
import { RiArrowRightSLine, RiCarLine, RiShieldCheckLine } from 'react-icons/ri'
        ...
        <div className=" md:flex my-8 lg:my-8 w-full lg:px-32 md:px-10">
            <div className=" flex flex-col items-center md:items-start">
                <div className=" font-rockNroll">
                    ...
                    <p className=" pt-1 text-2xl md:text-4xl md:my-4 my-2 
                  text-slate-800  font-extrabold ">
                    ...
                    <p className="pt-1 font-bold  text-2xl md:text-4xl text-slate-800
                    md:my-4 my-2 ">
                        food at {` `}
                        <span className=" text-red-600">
                            your door
                ...
                <div className=" flex gap-14 my-6">
                    <button className=" flex items-center transition md:font-bold
                ...
                px-3 py-1 rounded text-white">
                    ...
                    <button className="text-xs md:font-bold  text-red-500
