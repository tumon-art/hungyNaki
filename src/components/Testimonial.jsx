...
const Testimonial = () => {
    ...
    return (
        <section className=' md:grid md:mx-20 my-20 justify-center md:grid-cols-2'>
            <div className=" my-10 px-3 font-rockNroll">
                <h3 className=" text-1xl text-red-600">
                    Testimonial
                </h3>
                <h1 className=" my-4 text-slate-800 font-medium text-2xl">
                    What our {` `}
                ...
                <p className=" text-gray-500 my-7 text-xs font-sans">
                    Lorem ipsum dolor sit amet consectetur,
                    adipisicing elit. Distinctio quasi qui
                    minus quos sit perspiciatis inventore
